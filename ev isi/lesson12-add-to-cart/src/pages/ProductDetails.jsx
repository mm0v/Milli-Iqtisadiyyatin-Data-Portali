...
const ProductDetails = () => {
    ...
    const findProduct = product.find(p=>slugify(p.title,{lower:true}) === urlid)
                ...
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                            ...
                            <Button variant='warning ms-3' onClick={()=>{swal("Product added","","success"),addItem(findProduct)}}>Add to cart </Button>
                        </div>
                    </div>
                </div>
            </div>}
