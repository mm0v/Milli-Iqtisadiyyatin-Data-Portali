...
let catg = Number(prompt("kateqoriya:\n1.beauty\n2.fragrances\n3.furniture\n4.groceries"))
products.map(function (value) {
    if (catg === 1 && value.category === "beauty") {
        let brndbeauty = Number(prompt("Hansi Marka mehsul axtarirsiz?\n1.Essence \n2.Glamour Beauty\n3.Velvet Touch\n4.Chic Cosmetics"))
        if (brndbeauty === 1 && value.brand === "Essence") {
            console.log(value.title, value.price)

        } else if (brndbeauty === 2 && value.brand === "Glamour Beauty") {
            console.log(value.id, value.title, value.price)

        } else if (brndbeauty === 3 && value.brand === "Velvet Touch") {
            console.log(value.title, value.price)
            
        } else if (brndbeauty === 4 && value.brand === "Chic Cosmetics") {
            console.log(value.title, value.price)
        }
    } else if (catg === 2 && value.category === "fragrances") {
        let brndfragrance = Number(prompt("Hansi Marka mehsul axtarirsiz?\n1.Calvin Klein \n2.Chanel\n3.Dior\n4.Dolce & Gabbana"))
        if (brndfragrance === 1 && value.brand === "Calvin Klein") {
            console.log(value.title, value.price)
        } else if (brndfragrance === 2 && value.brand === "Chanel") {
            console.log(value.id, value.title, value.price)
        } else if (brndfragrance === 3 && value.brand === "Dior") {
            console.log(value.title, value.price)
        } else if (brndfragrance === 4 && value.brand === "Dolce & Gabbana") {
            console.log(value.title, value.price)
        }
    } else if (catg === 3 && value.category === "furniture") {
        let brndfurniture = Number(prompt("Hansi Marka mehsul axtarirsiz?\n1.Annibale Colombo\n2.Furniture Co\n3.Knoll\n4.Bath Trends"))
        if (brndfurniture === 1 && value.brand === "Annibale Colombo") {
            console.log(value.title, value.price)
        } else if (brndfurniture === 2 && value.brand === "Furniture Co") {
            console.log(value.id, value.title, value.price)
        } else if (brndfurniture === 3 && value.brand === "KNoll") {
            console.log(value.title, value.price)
        } else if (brndfurniture === 4 && value.brand === "Bath Trends") {
            console.log(value.title, value.price)
        }
    } else if (catg === 4 && value.category === "groceries") {
        console.log(value.tags, value.title, value.price)
    }

});


// // let prc=Number(prompt("Hansi qiymet araliginda mehsul axtarirsiniz?\n1. 1$-10$\n2. 10$-60$\n3. 60$-100$\n4.100$<"))
// // products.forEach(function(value){
// //     if(prc===1 && value.price>=1 && value.price<10){
// //         console.log(value.title, value.id)
// //     }else if(prc===2 && value.price>10 && value.price<=60){
// //         console.log(value.title, value.id)
// //     }
// //     else if(prc===3 && value.price>60 && value.price<=100){
// //         console.log(value.title, value.id)
// //     }
// //     else if(prc===4 && value.price>100){
// //         console.log(value.title, value.id)
// //     }
// // });
