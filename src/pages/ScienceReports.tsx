    ...
    <div className='p-5 mr-2'>
      ...
      <div className='flex justify-end mt-8'>
        <div className="space-y-6 w-[830px]">
          <div>
            <h1 className='text-white text-3xl font-bold'>Digər akademik nəşrlər</h1>
          </div>
          ...
          <div className="text-white">
            <Link to={"/academic_reports/financial_reports"}>
              <div className='flex justify-between items-center mt-6 border-1 p-5 rounded-[8xp]' style={{ borderColor: '#373641' }}>
                <div>
