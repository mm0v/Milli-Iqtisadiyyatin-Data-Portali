...
const GlobalInnovationIndexRank = () => {
      ...
      <div className="w-full max-w-[830px]">
        <div className="right-side mb-8">
          ...
          <div className="mt-10 w-full h-[300px] md:h-[400px] rounded-3xl overflow-hidden bg-white">
            <img src="your-image-url.jpg" alt="Global Innovation index" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
...
export default GlobalInnovationIndexRank